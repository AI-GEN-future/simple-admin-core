...
type RoleListReq struct {
	...
	RoleIds       *IDsReq                `protobuf:"bytes,7,opt,name=role_ids,json=roleIds,proto3,oneof" json:"role_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RoleListReq) GetRoleIds() *IDsReq {
	if x != nil {
		return x.RoleIds
	}
	return nil
...
const file_rpc_core_proto_rawDesc = "" +
	...
	"\x06remark\x18\x05 \x01(\tH\x02R\x06remark\x88\x01\x01\x12\x10\n" +
	...
	"\x0edefault_router\x18\x05 \x01(\tH\x02R\rdefaultRouter\x88\x01\x01\x12\x1b\n" +
	"\x06remark\x18\x06 \x01(\tH\x03R\x06remark\x88\x01\x01\x12,\n" +
	"\brole_ids\x18\a \x01(\v2\f.core.IDsReqH\x04R\aroleIds\x88\x01\x01B\a\n" +
	"\x05_nameB\a\n" +
	"\x05_codeB\x11\n" +
	"\x0f_default_routerB\t\n" +
	"\a_remarkB\v\n" +
	...
	"\x05total\x18\x01 \x01(\x04R\x05total\x12\"\n" +
	"\x04data\x18\x02 \x03(\v2\x0e.core.RoleInfoR\x04data\"H\n" +
	"\x14RoleMenuAuthorityReq\x12\x17\n" +
	"\arole_id\x18\x01 \x01(\x04R\x06roleId\x12\x17\n" +
	"\amenu_id\x18\x02 \x03(\x04R\x06menuId\"0\n" +
	"\x15RoleMenuAuthorityResp\x12\x17\n" +
	"\amenu_id\x18\x01 \x03(\x04R\x06menuId\"\x85\x03\n" +
	"\tTokenInfo\x12\x13\n" +
	...
	"\x0fusername_strict\x18\n" +
	" \x01(\tH\x05R\x0eusernameStrict\x88\x01\x01B\v\n" +
	"\t_usernameB\v\n" +
	"\t_nicknameB\b\n" +
	"\x06_emailB\t\n" +
	"\a_mobileB\x10\n" +
	"\x0e_department_idB\x12\n" +
	"\x10_username_strict\"H\n" +
	"\fUserListResp\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x04R\x05total\x12\"\n" +
	"\x04data\x18\x02 \x03(\v2\x0e.core.UserInfoR\x04data\")\n" +
	"\vUsernameReq\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername2\xf5\x1b\n" +
	"\x04Core\x12,\n" +
...
var file_rpc_core_proto_depIdxs = []int32{
	...
	22, // 10: core.RoleListReq.role_ids:type_name -> core.IDsReq
	37, // 11: core.RoleListResp.data:type_name -> core.RoleInfo
	42, // 12: core.TokenListResp.data:type_name -> core.TokenInfo
	47, // 13: core.UserListResp.data:type_name -> core.UserInfo
	...
	42, // 65: core.Core.createToken:input_type -> core.TokenInfo
	46, // 66: core.Core.deleteToken:input_type -> core.UUIDsReq
	43, // 67: core.Core.getTokenList:input_type -> core.TokenListReq
	45, // 68: core.Core.getTokenById:input_type -> core.UUIDReq
	45, // 69: core.Core.blockUserAllToken:input_type -> core.UUIDReq
	42, // 70: core.Core.updateToken:input_type -> core.TokenInfo
	47, // 71: core.Core.createUser:input_type -> core.UserInfo
	47, // 72: core.Core.updateUser:input_type -> core.UserInfo
	48, // 73: core.Core.getUserList:input_type -> core.UserListReq
	45, // 74: core.Core.getUserById:input_type -> core.UUIDReq
	50, // 75: core.Core.getUserByUsername:input_type -> core.UsernameReq
	46, // 76: core.Core.deleteUser:input_type -> core.UUIDsReq
	3,  // 77: core.Core.createApi:output_type -> core.BaseIDResp
	5,  // 78: core.Core.updateApi:output_type -> core.BaseResp
	2,  // 79: core.Core.getApiList:output_type -> core.ApiListResp
	0,  // 80: core.Core.getApiById:output_type -> core.ApiInfo
	5,  // 81: core.Core.deleteApi:output_type -> core.BaseResp
	41, // 82: core.Core.getMenuAuthority:output_type -> core.RoleMenuAuthorityResp
	5,  // 83: core.Core.createOrUpdateMenuAuthority:output_type -> core.BaseResp
	5,  // 84: core.Core.initDatabase:output_type -> core.BaseResp
	3,  // 85: core.Core.createConfiguration:output_type -> core.BaseIDResp
	5,  // 86: core.Core.updateConfiguration:output_type -> core.BaseResp
	10, // 87: core.Core.getConfigurationList:output_type -> core.ConfigurationListResp
	8,  // 88: core.Core.getConfigurationById:output_type -> core.ConfigurationInfo
	5,  // 89: core.Core.deleteConfiguration:output_type -> core.BaseResp
	3,  // 90: core.Core.createDepartment:output_type -> core.BaseIDResp
	5,  // 91: core.Core.updateDepartment:output_type -> core.BaseResp
	13, // 92: core.Core.getDepartmentList:output_type -> core.DepartmentListResp
	11, // 93: core.Core.getDepartmentById:output_type -> core.DepartmentInfo
	5,  // 94: core.Core.deleteDepartment:output_type -> core.BaseResp
	3,  // 95: core.Core.createDictionary:output_type -> core.BaseIDResp
	5,  // 96: core.Core.updateDictionary:output_type -> core.BaseResp
	19, // 97: core.Core.getDictionaryList:output_type -> core.DictionaryListResp
	...
	3,  // 100: core.Core.createDictionaryDetail:output_type -> core.BaseIDResp
	5,  // 101: core.Core.updateDictionaryDetail:output_type -> core.BaseResp
	16, // 102: core.Core.getDictionaryDetailList:output_type -> core.DictionaryDetailListResp
	14, // 103: core.Core.getDictionaryDetailById:output_type -> core.DictionaryDetailInfo
	5,  // 104: core.Core.deleteDictionaryDetail:output_type -> core.BaseResp
	16, // 105: core.Core.getDictionaryDetailByDictionaryName:output_type -> core.DictionaryDetailListResp
	3,  // 106: core.Core.createMenu:output_type -> core.BaseIDResp
	5,  // 107: core.Core.updateMenu:output_type -> core.BaseResp
	5,  // 108: core.Core.deleteMenu:output_type -> core.BaseResp
	24, // 109: core.Core.getMenuListByRole:output_type -> core.MenuInfoList
	24, // 110: core.Core.getMenuList:output_type -> core.MenuInfoList
	3,  // 111: core.Core.createOauthProvider:output_type -> core.BaseIDResp
	5,  // 112: core.Core.updateOauthProvider:output_type -> core.BaseResp
	31, // 113: core.Core.getOauthProviderList:output_type -> core.OauthProviderListResp
	29, // 114: core.Core.getOauthProviderById:output_type -> core.OauthProviderInfo
	5,  // 115: core.Core.deleteOauthProvider:output_type -> core.BaseResp
	32, // 116: core.Core.oauthLogin:output_type -> core.OauthRedirectResp
	47, // 117: core.Core.oauthCallback:output_type -> core.UserInfo
	3,  // 118: core.Core.createPosition:output_type -> core.BaseIDResp
	5,  // 119: core.Core.updatePosition:output_type -> core.BaseResp
	36, // 120: core.Core.getPositionList:output_type -> core.PositionListResp
	34, // 121: core.Core.getPositionById:output_type -> core.PositionInfo
	5,  // 122: core.Core.deletePosition:output_type -> core.BaseResp
	3,  // 123: core.Core.createRole:output_type -> core.BaseIDResp
	5,  // 124: core.Core.updateRole:output_type -> core.BaseResp
	39, // 125: core.Core.getRoleList:output_type -> core.RoleListResp
	37, // 126: core.Core.getRoleById:output_type -> core.RoleInfo
	5,  // 127: core.Core.deleteRole:output_type -> core.BaseResp
	6,  // 128: core.Core.createToken:output_type -> core.BaseUUIDResp
	5,  // 129: core.Core.deleteToken:output_type -> core.BaseResp
	44, // 130: core.Core.getTokenList:output_type -> core.TokenListResp
	42, // 131: core.Core.getTokenById:output_type -> core.TokenInfo
	5,  // 132: core.Core.blockUserAllToken:output_type -> core.BaseResp
	5,  // 133: core.Core.updateToken:output_type -> core.BaseResp
	6,  // 134: core.Core.createUser:output_type -> core.BaseUUIDResp
	5,  // 135: core.Core.updateUser:output_type -> core.BaseResp
	49, // 136: core.Core.getUserList:output_type -> core.UserListResp
	47, // 137: core.Core.getUserById:output_type -> core.UserInfo
	47, // 138: core.Core.getUserByUsername:output_type -> core.UserInfo
	5,  // 139: core.Core.deleteUser:output_type -> core.BaseResp
	77, // [77:140] is the sub-list for method output_type
	14, // [14:77] is the sub-list for method input_type
